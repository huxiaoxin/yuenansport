...
- (void)viewDidLoad {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        UIImageView *  keqiangSectionImgView =  [self keqiangboyConfigerSectionImg:CGRectMake(K(15), K(15), K(20), K(20)) keqaingimgname:@"jianjie"];
        ...
        [keqiangSeocndContnView addSubview:[self keqiangleftCofiferWithImg:CGRectMake(K(15), K(10), K(20), K(20)) keqiangboyImg:@"jiage"]];
        
        [keqiangSeocndContnView addSubview:[self keqiangleftCofiferWithImg:CGRectMake(K(15), K(10)+K(40), K(20), K(20)) keqiangboyImg:@"dizhinew"]];
        
        [keqiangSeocndContnView addSubview:[self keqiangleftCofiferWithImg:CGRectMake(K(15), K(10)+K(40+40), K(20), K(20)) keqiangboyImg:@"shijian"]];
        
        [keqiangSeocndContnView addSubview:[self keqiangleftCofiferWithImg:CGRectMake(K(15), K(10)+K(40+40+40), K(20), K(20)) keqiangboyImg:@"renshu"]];
        
        [keqiangSeocndContnView addSubview:[self keqiangleftCofiferWithImg:CGRectMake(K(15), K(10)+K(40+40+40+40), K(20), K(20)) keqiangboyImg:@"dianhua"]];
...
//
    ...
    [WHC_ModelSqlite update:[keqiangChangdiModel class] value:[NSString stringWithFormat:@" isColltecd = '%@'",@(weakSelf.keqnagMidol.isColltecd)] where:[NSString stringWithFormat:@"ContentID = '%ld'",weakSelf.keqnagMidol.ContentID]];
