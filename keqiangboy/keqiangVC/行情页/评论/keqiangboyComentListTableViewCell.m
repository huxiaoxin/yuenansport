...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        keqiangboylahieBtn.keqiangboyTopImgView.image = [UIImage imageNamed:@"lahei"];
        ...
        keqiangboyszanBtn.keqiangboyTopImgView.image = [UIImage imageNamed:@"点赞"];
        keqiangboyszanBtn.keqiangboybtomlb.text = @"点赞";
...
-(void)setKeqiangModel:(keqiangboyDetailComenrModle *)keqiangModel{
    ...
    if ([ISLogin isEqualToString:@"1"]) {
        _keqiangboyszanBtn.keqiangboyTopImgView.image = [UIImage imageNamed:keqiangModel.isZan ? @"点赞选中" : @"点赞"];
        
    }else{
        _keqiangboyszanBtn.keqiangboyTopImgView.image = [UIImage imageNamed:@"点赞"];
