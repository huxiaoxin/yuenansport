...
-(NSMutableArray *)keqiangboysnfoRightDataArr{
    if (!_keqiangboysnfoRightDataArr) {
        ...
        _keqiangboysnfoRightDataArr = [[NSMutableArray alloc]initWithArray:@[keqiangboysInfonameStr.length == 0 ? @"胡二狗的弟弟" :keqiangboysInfonameStr,keqiangboysInfosexStr.length == 0 ? @"男" : keqiangboysInfosexStr,keqiangboysnfoadressStr.length == 0 ? @"杭州-萧山" : keqiangboysnfoadressStr]];
    }
