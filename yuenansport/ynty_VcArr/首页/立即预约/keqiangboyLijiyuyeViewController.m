...
- (void)viewDidLoad {
    ...
    UIImageView *  keqiangSectionImgView =  [self keqiangboyConfigerSectionImg:CGRectMake(K(20), K(20)+NaviH, K(20), K(20)) keqaingimgname:@"yntyreadwirej"];
    ...
    [keqiangboyContentView addSubview:[self keqiangboyConfigerSectionImg:CGRectMake(K(15), K(12.5), K(15), K(15)) keqaingimgname:@"ynty_xingming"]];
    
    [keqiangboyContentView addSubview:[self keqiangboyConfigerSectionImg:CGRectMake(K(15), K(12.5)+K(40), K(15), K(15)) keqaingimgname:@"ynty_phone"]];

    [keqiangboyContentView addSubview:[self keqiangboyConfigerSectionImg:CGRectMake(K(15), K(12.5)+K(40+40), K(15), K(15)) keqaingimgname:@"yntynsdau"]];

    
    [keqiangboyContentView addSubview:[self keqiangboyConfigerSectionImg:CGRectMake(K(15), K(12.5)+K(40+40+40), K(15), K(15)) keqaingimgname:@"yntytimeicon"]];

    [keqiangboyContentView addSubview:[self keqiangboyConfigerSectionImg:CGRectMake(K(15), K(12.5)+K(40+40+40+40), K(15), K(15)) keqaingimgname:@"yntytimeicon"]];
...
-(void)keiqnahyueBntClick{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
      BOOL  keiqng =   [WHC_ModelSqlite update:[yntyHomeYundonModel class] value:[NSString stringWithFormat:@"isyuyue = '%@'",@(YES)] where:[NSString stringWithFormat:@"ContentID = '%ld'",self.keqiangModel.ContentID]];
        if (keiqng) {
        }
