...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self =[super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        [keqiangsouremoreBtn setBackgroundImage:[UIImage imageNamed:@"ynty_cloused"] forState:UIControlStateNormal];
        ...
        keqaingboyAdresImgView.image = [UIImage imageNamed:@"yntydajsgdajwguea"];
        ...
        keqiangcoemnbtn.keqianImg.image = [UIImage imageNamed:@"yntypinfludba"];
...
-(void)setKeqiangModel:(keqiangboyHangqingModel *)keqiangModel{
    ...
    if ([ISLogin isEqualToString:@"1"]) {
        _keqiangzanbtn.keqianImg.image = [UIImage imageNamed:keqiangModel.isZan ? @"yntyzan_sel" : @"ynty_zan_nomal"];
    }else{
        _keqiangzanbtn.keqianImg.image = [UIImage imageNamed:@"ynty_zan_nomal"];
