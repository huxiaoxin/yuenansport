...
-(NSMutableArray *)keqiangsendingDataArr{
    if (!_keqiangsendingDataArr) {
        _keqiangsendingDataArr = [[NSMutableArray alloc]initWithArray:@[[UIImage imageNamed:@"yntydajhgdakdgaq"]]];
    }
...
- (void)photosViewController:(UIViewController *)viewController
    ...
    [self.keqiangsendingDataArr addObject:[UIImage imageNamed:@"yntydajhgdakdgaq"]];
