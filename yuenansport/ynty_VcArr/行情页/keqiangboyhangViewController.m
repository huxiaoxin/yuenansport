...
- (void)viewDidLoad {
    ...
    [keqiangrightBtn setBackgroundImage:[UIImage imageNamed:@"ynty_read_icon"] forState:UIControlStateNormal];
...
-(void)keqiangsboyHeaderClicks{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        if (weakSelf.keqiangdataArr.count == 0) {
            ...
            LYEmptyView * keqiangemtyview = [LYEmptyView emptyViewWithImage:[UIImage imageNamed:@"yntynotlogin"] titleStr:@"暂无数据" detailStr:nil];
