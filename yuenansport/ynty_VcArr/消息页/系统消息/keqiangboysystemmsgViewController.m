...
-(NSMutableArray *)MaryThreeMgsDataArr{
    if (!_MaryThreeMgsDataArr) {
        _MaryThreeMgsDataArr = [[NSMutableArray alloc]initWithArray:@[@{@"title":@"关于06月30日i体育系统维护公告",@"issystem":@"1",@"cotent":@"尊敬用户，您好！\n因服务器升级需要，i体育将于2021年06月29日进行停机更新服务，大概需要两个小时，届时出现无法使用的情况，请稍安勿躁，静静的等待就可以了，感谢各位的大力支持！",@"img":@"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1599124455491&di=4a3a1d358ce0bfed1aab6463fae50eab&imgtype=0&src=http%3A%2F%2F5b0988e595225.cdn.sohucs.com%2Fimages%2F20171221%2Fc02c60287cc3469ab8440155f6813f56.jpeg",@"time":@"2021-06-21"}]];
    }
